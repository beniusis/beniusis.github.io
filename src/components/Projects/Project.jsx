export const Project = ({ data }) => {
  return (
    <div className="w-full flex justify-between items-center">
      <a
        className="flex flex-col justify-center items-start text-zinc-900 dark:text-zinc-50 cursor-pointer hover:opacity-70 hover:-translate-x-0.5 hover:-translate-y-0.5 xs:text-sm text-base max-w-[80%] w-full"
        href={data.url}
        target="_blank"
      >
      ...
      >
        <svg
          className="w-full h-full fill-zinc-900 dark:fill-zinc-50 hover:opacity-70"
          viewBox="0 0 24 24"
        >
