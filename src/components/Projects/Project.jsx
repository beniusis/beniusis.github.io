export const Project = ({ data }) => {
  return (
    <div className="flex w-full items-center justify-between">
      <a
        className="flex w-full max-w-[80%] cursor-pointer flex-col items-start justify-center text-base text-zinc-900 hover:-translate-x-0.5 hover:-translate-y-0.5 hover:opacity-70 xs:text-sm"
        href={data.url}
        target="_blank"
      >
      ...
      >
        <svg className="h-full w-full fill-zinc-900 hover:opacity-70" viewBox="0 0 24 24">
