export const Project = ({ data }) => {
  return (
    <div className="w-full flex justify-between items-center">
      <a
        className="flex flex-col justify-center items-start text-zinc-900 cursor-pointer hover:text-indigo-400 hover:-translate-x-1 hover:-translate-y-1 xs:text-sm text-base max-w-[80%] w-full"
        href={data.url}
        target="_blank"
      >
